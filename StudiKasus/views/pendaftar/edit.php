...
if (isset($_GET['id'])) {
    ...
    $pendaftarData = $pendaftarController->getPendaftarById($id);
    ...
    if ($pendaftarData) {
        if (isset($_POST['submit'])) {
            ...
            $result = $pendaftarController->updatePendaftar($id,$nama,$tempat_lahir,$jenis_kelamin,$agama,$alamat,$tanggal_lahir);
...
<body>
    <div class="container mt-4">
        ...
        <?php if ($pendaftarData): ?>
            <form action="" method="post">
                <div class="row">
                    <?php foreach ($pendaftarData as $d => $value): ?>
